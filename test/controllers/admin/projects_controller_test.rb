...
class Admin::ProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_project" do
    assert_difference('Admin::Project.count') do
      post admin_projects_url, params: { admin_project: { description: @admin_project.description, name: @admin_project.name } }
    end
  ...
  test "should update admin_project" do
    patch admin_project_url(@admin_project), params: { admin_project: { description: @admin_project.description, name: @admin_project.name } }
