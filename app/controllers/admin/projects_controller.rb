  ...
  def create
    ...
    respond_to do |format|
      if @admin_project.save
        format.html { redirect_to admin_project_url(@admin_project), notice: "Project was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_project.update(admin_project_params)
        format.html { redirect_to admin_project_url(@admin_project), notice: "Project was successfully updated." }
